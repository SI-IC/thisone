...
(() => {
  ...
  function safeStringify(value, opts = {}) {
    var _a2, _b, _c;
    const maxDepth = (_a2 = opts.maxDepth) != null ? _a2 : 6;
    ...
    function walk(v, depth) {
      ...
      if (v instanceof Error) {
        return { name: v.name, message: v.message, stack: (_a3 = v.stack) != null ? _a3 : null };
      }
  ...
  function installConsoleTap(size = 200) {
    ...
    for (const lvl of LEVELS) {
      const prev = (_a2 = console[lvl]) != null ? _a2 : (() => {
      });
      originals[lvl] = prev;
      console[lvl] = (...args) => {
        try {
  ...
  function findPiniaViaHook() {
    ...
    for (const entry of list) {
      const app = (_a2 = entry == null ? void 0 : entry.app) != null ? _a2 : entry;
  ...
  function findPiniaViaMountedRoot() {
    ...
    for (let i = 0; i < limit; i++) {
      ...
      const gp = (_a2 = app == null ? void 0 : app.config) == null ? void 0 : _a2.globalProperties;
      if (gp == null ? void 0 : gp.$pinia) return gp.$pinia;
    }
    return null;
  }
  function findPinia() {
    var _a2;
    return (_a2 = findPiniaViaHook()) != null ? _a2 : findPiniaViaMountedRoot();
  }
  ...
  function snapshotStore(args = {}) {
    ...
    return { store: args.store, state: safeStringify((_a2 = store.$state) != null ? _a2 : {}) };
  }
  function snapshotComponent(args = {}, lastEl) {
    ...
    const state = { ...(_a2 = inst.data) != null ? _a2 : {}, ...(_b = inst.setupState) != null ? _b : {} };
    return {
...
`;
  ...
  function boot() {
    ...
    const cfg = (_a2 = window.__CLAUDE_FEEDBACK_CFG__) != null ? _a2 : {};
